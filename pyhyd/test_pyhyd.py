"""Test suite for the pyhyd module."""
...
# ph.reynolds(D, Q, T=10.0, de=1000.0)
...
# friction_factor(D, Q, k_s, T=10.0, den=1000.0, warn=False)
...
# ph.hyd_grad(D, Q, k_s, T=10.0, den=1000.0)
...
def test_hyd_grad():
    ...
    # NB with EPANET the 'unit headloss' is
    # the headloss per 1000m if using SI units
